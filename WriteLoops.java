...
public class WriteLoops {
    ...
    public int driveHome() {
        ...
        while (w < 6) {
            ...
            if (!gpsCurrentLocation().equals("Home"))
                System.out.println("driveSomeMore()");
    ...
    public boolean checkGameScore() {
        /////THIS TEST EXPECXTS A BOOLEAN BUT THE METHOD RETURNS A INT. 
        /////I CHANGED IT TO RETURN A BOOLEAN WHICH TRACKS IF RUNNING SCORE IS > HIGHEST SCORE
        /////THIS SEEMS LIKE THE MOST LOGICAL RETURN GIVEN WHAT THE WHILE LOOP IS EXPECTING
        boolean w = false;
